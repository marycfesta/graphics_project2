...
* General
  ...
  * I created a set of basic shapes which would be transformed into different areas of the picture to create the geometry of the full image. These included:
    ...
    * Circle (filled, open)
    * Triangle (filled)
  * I also had a set of more complicated assorted shapes, which were normally for much more specific sections of the painting, which often needed to be repeated but were more complex than basic geometry.
...
* What I am most proud of
  ...
  * My use of transparency and randomness to create a semblance of the painting's texture. I believe it adds dimension to the piece.
...
* What I might like to rework
  ...
  * The S shape of the holes in the violin seems very inefficient, as it involved multiple segments not created in a loop, so I would like to rework this.
